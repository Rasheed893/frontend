                  ...
                  <div className="lg:col-span-2">
                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                      ...
                      <div className="md:col-span-3">
                        <label htmlFor="address" className="dark:text-gray-200">Address / Street</label>
                        <input
                      ...
                      <div className="md:col-span-2">
                        <label htmlFor="country" className="dark:text-gray-200">Country / region</label>
                      ...
                      <div className="md:col-span-3">
                        <label htmlFor="promo" className="dark:text-gray-200">Promo Code</label>
                      ...
                      <div className="md:col-span-5">
                        <label htmlFor="deliveryNotes" className="dark:text-gray-200">Delivery Notes</label>
                        <textarea
                          id="deliveryNotes"
                          name="deliveryNotes"
                          value={deliveryNotes}
                      ...
                      <div className="md:col-span-5 mt-3">
                        <div className="inline-flex items-center">
                          ...
                          />
                          <label htmlFor="billing_same" className="ml-2 dark:text-gray-200">
                            I am aggree to the{" "}
            ...
            {availablePromos.length === 0 ? (
              ...
              <ul className="space-y-3 text-sm">
                {availablePromos.map((promo) => (
                  <li key={promo.code} className="border-b pb-2 dark:border-gray-700">
                    <p className="font-medium text-blue-700 dark:text-blue-400">{promo.code}</p>
                    <p className="text-gray-700 dark:text-gray-300">{promo.promoDescription}</p>
